...
Arduino_DataBus *bus = new Arduino_ESP32SPIDMA(8   /* DC */, 10 /* CS */, 12 /* SCK */, 11 /* MOSI */, GFX_NOT_DEFINED /* MISO */, HSPI  /* spi_num */);
Arduino_GFX *gfx = new Arduino_ST7789(
    bus, 9, 3 /* Rotation 3 */, true /* IPS */,
    135 /* width */, 240 /* height */,
    52, 40,  /* 修改这里：将 col_offset 改为 52, row_offset 改为 40 */
    52, 40   /* 对应的 offset2 也同步修改 */
);
...
//debug lcd color
  ...
  USB.usbClass(0xff);
  USB.PID(0x2987);
  USB.productName("esp32s2_R135x240_Fps15_Bl18_Ejpg15");
  USB.begin();
#endif
}
